...
import 'package:workshop_flutter_app/model/movies/list/view_model/impl/movie_list_view_model_impl.dart';
...
class MovieListState extends State<MovieList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.title, style: TextStyle(fontSize: 26.0),),
        centerTitle: false,
      ),
      body: StreamBuilder(
